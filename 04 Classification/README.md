Classification is a supervised ML task that predicts categorical labels for input data. It's vital for applications like sentiment analysis, fraud detection, and medical diagnosis.
